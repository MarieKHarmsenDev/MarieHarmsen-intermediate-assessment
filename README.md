...
Additional things I would do if I had more time/for production:
I would add a better salting algrorithm through a library and get the API key from a backend service. 
Add accesibility for visually impaired.
Add tests for the list view model
Add UI tests
